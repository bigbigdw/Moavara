    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            if(mode == "USER" && UID != ""){
                ...
                if(Genre.getGenre(this@ActivityRegister).toString() == "FANTASY"){
                    llayoutBtn1.background = llayoutBtnOnBG
                } else if(Genre.getGenre(this@ActivityRegister).toString() == "ROMANCE"){
                    llayoutBtn2.background = llayoutBtnOnBG
                }
                else if(Genre.getGenre(this@ActivityRegister).toString() == "ALL"){
                    llayoutBtn3.background = llayoutBtnOnBG
                }
                else if(Genre.getGenre(this@ActivityRegister).toString() == "BL"){
                ...
                llayoutBtnNickname.setOnClickListener{
                    if(etviewNickname.text.toString() == ""){
                        Toast.makeText(this@ActivityRegister, "닉네임을 설정해 주세요", Toast.LENGTH_SHORT).show()
                    } else {
                        nicknameConfirm()
                    }
                }
            ...
            llayoutBtnGenre.setOnClickListener {
                with(binding){
                    if(genre == ""){
                        Toast.makeText(this@ActivityRegister, "장르를 선택해 주세요", Toast.LENGTH_SHORT).show()
                    } else {
                        ...
                        val rightListener = View.OnClickListener {
                            ...
                            val intent = Intent(this@ActivityRegister, ActivityGuide::class.java)
            ...
            llayoutApplyGenre.setOnClickListener {
                ...
                val rightListener = View.OnClickListener {
                    ...
                    Toast.makeText(this@ActivityRegister, "변경이 완료되었습니다.", Toast.LENGTH_SHORT).show()
                    val novelIntent = Intent(this@ActivityRegister, ActivityMain::class.java)
