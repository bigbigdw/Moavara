...
class AdapterBestWeekendOld(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = ItemBooklistBestWeekendOldBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class HolderBestWeekend internal constructor(val binding: ItemBooklistBestWeekendOldBinding) :
