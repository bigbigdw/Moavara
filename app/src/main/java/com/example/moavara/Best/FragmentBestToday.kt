...
class FragmentBestToday() : Fragment() {
    ...
    private fun setupViewPager(viewPager: ViewPager?) {
        ...
        adapter.addFragment(FragmentBestTodayTab("Naver"), "네이버 웹소설")
        adapter.addFragment(FragmentBestTodayTab("Naver"), "네이버 챌린지리그")
        adapter.addFragment(FragmentBestTodayTab("Naver"), "네이버 베스트리그")
        adapter.addFragment(FragmentBestTodayTab("Kakao"), "카카오 페이지")
        adapter.addFragment(FragmentBestTodayTab("Kakao"), "카카오 스테이지")
